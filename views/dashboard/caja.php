          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="../views/cajero.php?c=PerfilController" class="nav-link">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="../views/cajero.php?c=VentaController&a=verVentasCajero" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Procesar Venta</p>
                  </a>
                </li>
            ...
            <li class="nav-item menu-open ">
              <a href="../views/cajero.php?c=InicioController&a=cerrarSession" class="nav-link">
