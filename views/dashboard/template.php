          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="../views/administrador.php?c=PerfilController" class="nav-link">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="../views/administrador.php?c=InicioController" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Administración</p>
                  </a>
                </li>
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="../views/administrador.php?c=UsuarioController" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Usuarios</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="../views/administrador.php?c=MarcaController" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Marcas</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="../views/administrador.php?c=ProductoController" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Productos</p>
                  </a>
                </li>
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="../views/Administrador.php?c=VentaController&a=verVentasAdmin" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Ordenes</p>
                  </a>
                </li>
            ...
            <li class="nav-item menu-open ">
              <a href="../views/Administrador.php?c=InicioController&a=cerrarSession" class="nav-link">
