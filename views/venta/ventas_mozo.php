            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-4">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="../views/mozo.php?c=VentaController"
                                class="btn btn-success">NUEVA VENTA</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                ...
                                <table class="table table-striped table-hover" id="tbl-Venta">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="mozo.php?c=VentaController&a=enviarVenta&id=<?php echo $row["idPedido"]; ?>"class="btn btn-success btn-block">Enviar a Caja</a></td>
                                        </tr>
                                        <?php
